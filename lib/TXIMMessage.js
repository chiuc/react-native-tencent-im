import { NativeEventEmitter, NativeModules, DeviceEventEmitter, NativeAppEventEmitter } from 'react-native';
...
export default {
    ...
    addConversationRefreshListener(listener, context) {
        if (Platform.OS == "ios") {
            return emitter.addListener(EventName.onConversationRefresh, listener, context);
        } else {
            return NativeAppEventEmitter.addListener(
                EventName.onConversationRefresh,
                data => {
                    const res = {
                        data: data
                    }
